    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-400 to-blue-600 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">Welcome to Spotify Sync</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          ...
          <div className="text-center text-sm text-gray-600 mt-4">
            ...
            <p className="mt-1">We&apos;ll access your Spotify profile and currently playing music.</p>
          </div>
        </CardContent>
      </Card>
    </div>
